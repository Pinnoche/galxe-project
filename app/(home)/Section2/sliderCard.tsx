...
const Card = ({ tag, description, poster }: CardList) => {
  return (
    <div className="relative cursor-pointer min-w-[32%] min-h-[16.25rem] p-5 bg-[#1b1e24] rounded-xl mt-4 mb-10 hover:shadow-gray-700 shadow-lg move-up tablet:min-w-[49%] phone:min-w-[100%]">
