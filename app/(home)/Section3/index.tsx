...
import data from '@/app/components/Card/CardsData.json'
...
function Section3() {
    ...
    return (
        <div className='bg-sect3 bg-no-repeat bg-fifty bg-hundred pl-7 py-9 w-full overflow-x-hidden xl:pb-16 xl:pt-16 xl:px-[4.5rem]'>
